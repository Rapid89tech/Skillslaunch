...
export const lesson4TaxObligations: Lesson = {
  id: 4,
  title: 'Understanding Tax Obligations and Legal Requirements',
  duration: '12 minutes',
  type: 'video',
  content: {
    videoUrl: 'https://youtu.be/HJZyoy8cf-M?si=E1yY21UX6xMWCsBN',
    textContent: `
