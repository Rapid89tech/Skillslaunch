...
export const lesson3BenefitsOfEntrepreneurship: Lesson = {
  id: 3,
  title: 'Benefits of Becoming an Entrepreneur',
  duration: '15 minutes',
  type: 'video',
  content: {
...
Entrepreneurship is not just about personal gain—it's about creating value for others while building something meaningful that can benefit your entire community.`
  }
};
