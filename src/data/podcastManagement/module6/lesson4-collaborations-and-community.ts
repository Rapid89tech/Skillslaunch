...
export const lesson4CollaborationsAndCommunity: VideoLesson = {
  id: 4,
  title: 'Collaborations and Community Building',
  duration: '70 minutes',
  type: 'video',
  content: {
    videoUrl: 'https://youtu.be/your-video-link-for-collaborations', // Placeholder, actual link from doc
    textContent: `
...
Track the growth of your community across different platforms to measure engagement success.

### 2. Engagement (Comments, DMs, Replies)
Monitor how actively your community participates in discussions and interactions.

### 3. Shares and Tags on Social
Measure how often your content is shared and tagged by community members.

### 4. Listener Retention Across Episodes
Track how community engagement correlates with listener retention and episode downloads.
...
### 1. Be Generous
Share others' content and support fellow creators to build reciprocal relationships.

### 2. Be Consistent
Maintain regular engagement and communication with your community.

### 3. Be Authentic
Show your genuine personality and values in all community interactions.

### 4. Celebrate Fans
Recognize and appreciate your community members' contributions and support.
