...
export const lesson3ShingleTileAndMetalPanelInstallation: Lesson = {
  id: 3,
  title: 'Shingle, Tile, and Metal Panel Installation',
  duration: '60 min',
  type: 'video',
  content: {
    videoUrl: 'https://youtu.be/p0VM9L-0SYE',
    textContent: `
...
* **Asphalt Shingles**:
  **YOUTUBE LINK** https://youtu.be/p0VM9L-0SYE   
...
* **Roof Tiles (Concrete/Clay)**: 
  **YOUTUBE LINK** https://youtu.be/U6quyFsO-FY   
...
* **Metal Panels (Corrugated/Standing Seam)**:
  **YOUTUBE LINK** https://youtu.be/pmIF5kAnDMk   
