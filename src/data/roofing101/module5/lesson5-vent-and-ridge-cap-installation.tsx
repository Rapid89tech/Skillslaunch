...
export const lesson5VentAndRidgeCapInstallation: Lesson = {
  id: 5,
  title: 'Vent and Ridge Cap Installation',
  duration: '45 min',
  type: 'video',
  content: {
    videoUrl: 'https://youtu.be/v33nWJaWGRs',
    textContent: `
# Vent and Ridge Cap Installation 🧾

## Introduction

**YOUTUBE LINK** https://youtu.be/v33nWJaWGRs
...
## Balanced Ventilation and Maintenance
