...
export const lesson3UnderlaymentInRoofing: Lesson = {
  id: 3,
  title: 'Underlayment in Roofing',
  duration: '45 min',
  type: 'video',
  content: {
    videoUrl: 'https://youtu.be/SptrN0DBJek',
    textContent: `
# Underlayment in Roofing 🧾

## Definition of Underlayment

**YOUTUBE LINK** https://youtu.be/SptrN0DBJek
...
**YOUTUBE LINK** https://youtu.be/YQiz2K39ibs
