...
export const lesson2TitlesAndDescriptions: Lesson = {
  id: 2,
  title: '📝 Crafting Compelling Titles & Descriptions',
  duration: '40 min',
  type: 'lesson',
  content: [
    {
      id: 1,
      title: 'Why Titles & Descriptions Matter',
      keyFeatures: [
        'Discovery (via Search & SEO) - boosts visibility on platforms and search engines',
        'Click-Through Rates - encourages listeners to play episodes',
        'Listener Retention - keeps listeners coming back',
        'Social Sharing and Link Previews - makes episodes shareable on social media'
      ],
      textContent: `
...
Engaging titles and descriptions enhance on-demand access by making episodes shareable on social media, driving streams or downloads. A catchy title like "Top 10 Tech Trends" and a description with a hook generate compelling link previews on Twitter, encouraging clicks to Apple Podcasts. This shareability supports global accessibility during leisure or travel, ensuring listeners can engage with content anytime, boosting visibility and retention through social promotion.
    ...
    {
      id: 2,
      title: 'Crafting Effective Episode Titles',
      keyFeatures: [
        'Be Clear, Not Clever - prioritize clarity over vague or clever titles',
        'Use Keywords for Searchability - include niche-relevant terms',
        'Use Numbers, Lists, or "How-To" Framing - structure titles for appeal',
        'Keep It Short & Skimmable - aim for under 60 characters'
      ],
      textContent: `
...
## Use Numbers, Lists, or "How-To" Framing
...
Short, skimmable titles under 60 characters, like "Time-Saving Content Tools," enhance on-demand access by fitting podcast app displays, encouraging clicks on Apple Podcasts during travel. Front-loading keywords ensures visibility, supporting global accessibility as listeners stream or download episodes anytime. Concise titles boost engagement by making content easy to scan and access, fostering retention in a mobile-driven world.
    ...
    {
      id: 3,
      title: 'Writing Engaging Episode Descriptions',
      videoUrl: 'https://youtu.be/eODi-UD9T_Q',
      keyFeatures: [
        'Start with a Hook - first 1–2 lines grab attention',
        'Include Key Points or Timestamps - use bullets or timestamps for scannability',
        'Add Guest Info - highlight guest credentials and links',
        'Include CTAs - encourage actions like subscribing or joining newsletters',
        'Use Keywords Naturally - incorporate relevant terms for SEO'
      ],
      textContent: `
# 📝 Writing Engaging Episode Descriptions ✍️
...
## Include Key Points or Timestamps
...
Using keywords naturally in descriptions, like "content marketing strategies," enhances on-demand access by improving SEO on Spotify and Google. Relevant terms attract listeners searching for topics, encouraging streams or downloads during leisure. This ensures global accessibility, as listeners find episodes anytime, boosting engagement and retention through discoverable, optimized descriptions.
    ...
    },
    {
      ...
      keyFeatures: [
        'Vague or Clickbaity Titles - misleads and erodes trust',
        'Only Using Episode Numbers - lacks searchability',
        'Overloading with Links - feels spammy and confusing',
        'Writing Blocks of Text - hard to skim, reduces engagement',
        'Skipping Description Entirely - misses SEO and engagement opportunities'
      ],
      textContent: `
# 🚫 Common Mistakes to Avoid ⚠️

## Vague or Clickbaity Titles
...
Skipping descriptions reduces on-demand access by missing SEO and engagement opportunities on Apple Podcasts. A detailed description with keywords and CTAs attracts listeners, encouraging streams or downloads during travel. Including key points ensures global accessibility, making episodes discoverable and engaging anytime, boosting retention through optimized, informative content.
    ...
    {
      id: 5,
      title: 'Activity: Rewrite Episode Titles',
      keyFeatures: [
        'Rewrite "Episode 22" into how-to, list-style, and curiosity-driven versions',
        'Create a 3-sentence description with hook, value, and CTA',
        'Ensure accessible, engaging episodes'
      ],
      textContent: `
# 🧪 Activity: Rewrite Episode Titles 📚
