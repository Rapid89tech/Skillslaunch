...
export const lesson2BasicEditingTechniques: Lesson = {
  id: 2,
  ...
  content: [
    {
      ...
      textContent: `Even the best content can lose impact if the **audio is distracting or unpleasant**. Basic editing helps:
