...
export const lesson4ScalingYourPodcast: Lesson = {
  id: 4,
  title: 'Scaling Your Podcast',
  duration: '55 min',
  type: 'video',
  content: {
    videoUrl: '',
...
## What Does Scaling a Podcast Mean? 📈
...
## Grow and Retain Your Audience ❤️
