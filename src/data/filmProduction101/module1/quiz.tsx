...
export const module1Quiz: Quiz = {
  id: 1,
  title: 'Module 1 Quiz: Introduction to Film Production',
  description: 'Test your knowledge of film production basics, the film industry, roles on set, film types, and cinema history.',
  questions: [
    {
      id: 1,
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: 'Pre-production focuses on planning and preparation, including casting, location scouting, and designing sets and costumes.'
    },
    {
      id: 5,
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: 'The cinematographer is responsible for the film\'s visual look, managing camera work, lighting, and shot composition.'
    },
    {
      id: 7,
      ...
      correctAnswer: 3,
      explanation: 'Post-production transforms raw footage into a polished film through editing, sound design, visual effects, and color grading.'
    },
    {
      id: 8,
      ...
      correctAnswer: 0,
      explanation: 'Distribution involves delivering the finished film to audiences through theaters, streaming platforms, or physical media.'
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation: 'Budget constraints and time management are common challenges that filmmakers face during production.'
    },
    {
      id: 10,
      ...
      correctAnswer: 3,
      explanation: 'Television commercials are not considered a type of film. The main types include feature films, documentaries, short films, animation, and experimental films.'
    }
  ]
};
