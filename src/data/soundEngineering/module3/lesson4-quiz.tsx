...
**Explanation**: Omnidirectional microphones pick up sound equally from all directions (360°), making them ideal for capturing ambient sound and group conversations.
...
## Question 12
**Which stereo miking technique uses two cardioids at 90° with capsules close together?**
...
**Explanation**: XY technique uses two cardioid microphones positioned at 90° to each other with capsules close together for a tight stereo image.
...
A. On-axis placement  
B. Slight off-axis placement (15-30°)  
C. Very close placement  
D. Distant placement  

**Answer**: B

**Explanation**: Slight off-axis placement (15-30°) helps reduce harshness and sibilance by avoiding direct on-axis pickup of high-frequency sounds.
