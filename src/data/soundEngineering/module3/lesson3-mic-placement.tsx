...
export const lesson3MicPlacement: Lesson = {
  id: 'lesson3-mic-placement',
...
1. **Mic placement** significantly affects recording quality and tone
2. **Distance** determines proximity effect and room sound
3. **Angle** affects tonal character and reduces unwanted sounds
4. **Different instruments** require specific placement techniques
5. **Stereo techniques** create spatial imaging and depth
6. **Common mistakes** can be avoided with proper technique
7. **Real-time monitoring** helps optimize placement
8. **Room treatment** enhances placement effectiveness
9. **Documentation** preserves successful setups
10. **Practice and experimentation** develop placement skills
  `
};

export default lesson3MicPlacement; 