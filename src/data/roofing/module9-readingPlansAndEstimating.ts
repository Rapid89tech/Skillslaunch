...
export const module9ReadingPlansAndEstimating: Module = {
  ...
  description: 'Learn to read blueprints and roof plans, calculate roof pitch and area, perform material take-offs, calculate waste factors, and create accurate cost estimates for roofing projects.',
  lessons: [
    {
      id: 50,
